...
const PROJECTS: ProjectSpec[] = [
  {
    name: '[DEMO] BOT Automation for MES User Management',
    code: 'DEMO-CC-2026-0011',
    lifecycle: 'change_control',
    team: '[DEMO] MES',
    owner: 'demo.rahul@pragati.local',
    description:
      'Implementation of BOT-based Automation for Account Unlock, User ID deactivation and Reactivation for the Manufacturing Execution System.',
    daysFromNow: 35,
    priority: 'high',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] LIMS v3.4 Validation',
    code: 'DEMO-CSV-2026-021',
    lifecycle: 'csv',
    team: '[DEMO] CSV',
    owner: 'demo.rahul@pragati.local',
    description: 'Computer System Validation per GAMP 5 Cat 4 for the LIMS v3.4 upgrade.',
    daysFromNow: 60,
    priority: 'critical',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] Chromatography Audit Trail Review',
    code: 'DEMO-DI-2026-008',
    lifecycle: 'deviation',
    team: '[DEMO] Data Integrity',
    owner: 'demo.ananya@pragati.local',
    description: 'Shared-login deviation on CDS during batch release — ALCOA+ assessment + CAPA.',
    daysFromNow: 14,
    priority: 'critical',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] Annual SOP Refresh',
    code: 'DEMO-SOP-2026-014',
    lifecycle: 'sop',
    team: '[DEMO] QA-IT',
    owner: 'demo.lead@pragati.local',
    description: 'Author → review → approve → train cycle for QA-IT SOPs.',
    daysFromNow: 80,
    priority: 'medium',
    gxpImpact: 'medium',
  },
  {
    name: '[DEMO] PV Case Intake Quality Audit',
    code: 'DEMO-AUD-2026-005',
    lifecycle: 'audit',
    team: '[DEMO] Pharmacovigilance',
    owner: 'demo.dhruv@pragati.local',
    description: 'Quarterly internal audit of adverse event case intake.',
    daysFromNow: 20,
    priority: 'high',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] eQMS Sprint 14',
    code: 'DEMO-AGI-2026-014',
    lifecycle: 'agile_sprint',
    team: '[DEMO] QA-IT',
    owner: 'demo.lead@pragati.local',
    description: 'Two-week sprint delivering the deviation module enhancements.',
    daysFromNow: 10,
    priority: 'high',
  },
  {
    name: '[DEMO] EBR Print Issue — CAPA',
    code: 'DEMO-CAPA-2026-003',
    lifecycle: 'capa',
    team: '[DEMO] Operations',
    owner: 'demo.lead@pragati.local',
    description: 'Root cause + corrective action for electronic batch record print failures.',
    daysFromNow: 45,
    priority: 'high',
    gxpImpact: 'medium',
  },
  {
    name: '[DEMO] Backup & Restore Validation',
    code: 'DEMO-VAL-2026-018',
    lifecycle: 'validation',
    team: '[DEMO] CSV',
    owner: 'demo.rahul@pragati.local',
    description: 'Validate the new backup-restore procedure for GxP systems.',
    daysFromNow: 55,
    priority: 'medium',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] Quality Manual v2.1 Release',
    code: 'DEMO-REL-2026-002',
    lifecycle: 'software_release',
    team: '[DEMO] QA-IT',
    owner: 'demo.lead@pragati.local',
    description: 'Coordinated release of the updated Quality Manual.',
    daysFromNow: -3,
    priority: 'medium',
  },
  {
    name: '[DEMO] Reviewer Onboarding Programme',
    code: 'DEMO-PRJ-2026-031',
    lifecycle: 'generic',
    team: '[DEMO] QA-IT',
    owner: 'demo.ananya@pragati.local',
    description: 'Onboarding curriculum for new QA reviewers.',
    daysFromNow: 70,
    priority: 'low',
  },
  {
    name: '[DEMO] HPLC Audit Trail Enhancement',
    code: 'DEMO-CC-2026-0012',
    lifecycle: 'change_control',
    team: '[DEMO] CSV',
    owner: 'demo.rahul@pragati.local',
    description: 'Change control to enable extended audit trail logging on HPLC systems.',
    daysFromNow: 40,
    priority: 'medium',
    gxpImpact: 'high',
  },
  {
    name: '[DEMO] Adverse Event Coding QA',
    code: 'DEMO-AUD-2026-006',
    lifecycle: 'audit',
    team: '[DEMO] Pharmacovigilance',
    owner: 'demo.dhruv@pragati.local',
    description: 'Quality review of MedDRA coding across the last quarter.',
    daysFromNow: 12,
    priority: 'high',
    gxpImpact: 'medium',
  },
...
const TEAMS: TeamSpec[] = [
  {
    name: '[DEMO] QA-IT',
    description: 'Quality Informatics — owns the digital quality stack.',
    function: 'general',
  ...
  {
    name: '[DEMO] CSV',
    description: 'Computer System Validation — GAMP 5 lifecycles.',
  ...
  },
  {
    ...
    description: 'ALCOA+ enforcement, audit trail review, deviations.',
    function: 'general',
  ...
  {
    name: '[DEMO] Pharmacovigilance',
    description: 'Adverse event intake, triage and reporting.',
    function: 'general',
  ...
  },
  {
    ...
    description: 'Manufacturing operations + lab support tools.',
    function: 'general',
    lead: 'demo.lead@pragati.local',
  ...
  {
    name: '[DEMO] MES',
    description: 'Manufacturing Execution System — shared CC programme.',
    function: 'general',
    lead: 'demo.rahul@pragati.local',
    members: [
      'demo.rahul@pragati.local',
