 ...
 *   demo.<first>@pragati.local     — 14 supporting engineers
 *
...
import { DEMO_EMAIL_RX } from '../src/lib/demo';
...
// cleanup doesn't depend on any one query. The demo-email pattern is shared
// with the auth path (src/lib/demo.ts) so seeding and lockout-immunity can
// never disagree on what counts as a demo account.
...
const ORGS = ['SpaceX', 'Tesla', 'xAI'];

const PEOPLE: DemoUser[] = [
  {
    email: 'demo.lead@pragati.local',
    username: 'demo.lead',
    name: 'Elon Musk (Demo)',
    role: 'lead',
  ...
  },
  {
    ...
    org: ORGS[0],
    dept: 'Propulsion',
    employeeId: 'DEMO-2001',
    avatarBg: '#F8BBD9',
  },
  {
    email: 'demo.rahul@pragati.local',
    username: 'demo.rahul',
    name: 'Gwynne Shotwell (Demo)',
    role: 'lead',
    title: 'President & COO',
    org: ORGS[0],
    dept: 'Operations',
    employeeId: 'DEMO-1002',
    avatarBg: '#0EA5E9',
    avatarFont: 0,
  },
  {
    email: 'demo.ananya@pragati.local',
    username: 'demo.ananya',
    name: 'Nadia Brooks (Demo)',
    role: 'lead',
    title: 'Director, Autopilot',
    org: ORGS[1],
    dept: 'Autopilot',
    employeeId: 'DEMO-1003',
    avatarBg: '#22C55E',
    avatarFont: 0,
  },
  {
    email: 'demo.dhruv@pragati.local',
    username: 'demo.dhruv',
    name: 'Andrej Karpathy (Demo)',
    role: 'lead',
    title: 'Head of AI',
    org: ORGS[2],
    dept: 'AI',
    employeeId: 'DEMO-1004',
    avatarBg: '#F59E0B',
    avatarFont: 0,
  },
  {
    email: 'demo.neha@pragati.local',
    username: 'demo.neha',
    ...
    org: ORGS[1],
    dept: 'Powertrain',
    employeeId: 'DEMO-2002',
    avatarBg: '#FDBA74',
  },
  {
    email: 'demo.vikram@pragati.local',
    username: 'demo.vikram',
    name: 'Marco Rossi (Demo)',
    role: 'contributor',
    title: 'Structures Engineer',
    org: ORGS[0],
    dept: 'Structures',
    employeeId: 'DEMO-2003',
    avatarBg: '#FDE047',
  },
  {
    email: 'demo.meera@pragati.local',
    username: 'demo.meera',
    name: 'Hannah Park (Demo)',
    role: 'contributor',
    title: 'Validation Engineer',
    org: ORGS[1],
    dept: 'Powertrain',
    employeeId: 'DEMO-2004',
    avatarBg: '#86EFAC',
  },
  {
    email: 'demo.arjun@pragati.local',
    username: 'demo.arjun',
    name: 'Sam Okafor (Demo)',
    role: 'contributor',
    title: 'Avionics Engineer',
    org: ORGS[0],
    dept: 'Avionics',
    employeeId: 'DEMO-2005',
    avatarBg: '#7DD3FC',
  },
  {
    email: 'demo.isha@pragati.local',
    username: 'demo.isha',
    name: 'Maya Chen (Demo)',
    role: 'contributor',
    ...
    org: ORGS[2],
    dept: 'AI',
    employeeId: 'DEMO-2006',
    avatarBg: '#C4B5FD',
  },
  {
    email: 'demo.rohit@pragati.local',
    username: 'demo.rohit',
    ...
    org: ORGS[0],
    dept: 'Software',
    employeeId: 'DEMO-2007',
    avatarBg: '#FCA5A5',
  },
  {
    email: 'demo.tara@pragati.local',
    username: 'demo.tara',
    name: 'Aisha Rahman (Demo)',
    role: 'contributor',
    title: 'Reliability Engineer',
    org: ORGS[0],
    dept: 'Quality',
    employeeId: 'DEMO-2008',
    avatarBg: '#A7F3D0',
  },
  {
    email: 'demo.aditya@pragati.local',
    username: 'demo.aditya',
    name: 'Ben Carter (Demo)',
    role: 'contributor',
    title: 'Battery Engineer',
    org: ORGS[1],
    dept: 'Powertrain',
    employeeId: 'DEMO-2009',
    avatarBg: '#FBCFE8',
  },
  {
    email: 'demo.kavya@pragati.local',
    username: 'demo.kavya',
    name: 'Lin Wei (Demo)',
    role: 'contributor',
    ...
    org: ORGS[0],
    dept: 'Starlink',
    employeeId: 'DEMO-2010',
    avatarBg: '#FED7AA',
  },
  {
    email: 'demo.manish@pragati.local',
    username: 'demo.manish',
    name: 'Carlos Mendes (Demo)',
    role: 'contributor',
    title: 'Manufacturing Engineer',
    org: ORGS[1],
    dept: 'Gigafactory',
    employeeId: 'DEMO-2011',
    avatarBg: '#FEF08A',
  },
  {
    email: 'demo.pooja@pragati.local',
    username: 'demo.pooja',
...
if (WITH_ADMIN) {
  PEOPLE.unshift({
    email: 'demo.admin@pragati.local',
    username: 'demo.admin',
    name: 'Demo Admin',
    role: 'admin',
...
const PROJECTS: ProjectSpec[] = [
  {
    name: '[DEMO] Raptor 3 Production Ramp',
    code: 'DEMO-RAP-2026-0011',
    lifecycle: 'product_launch',
    team: '[DEMO] Raptor Propulsion',
    owner: 'demo.rahul@pragati.local',
    description:
      'Scale Raptor 3 engine production to meet the Starship flight manifest — tooling, test stands, and throughput.',
    daysFromNow: 35,
    priority: 'high',
  },
  {
    name: '[DEMO] 4680 Cell Line Qualification',
    code: 'DEMO-VAL-2026-021',
    lifecycle: 'validation',
    team: '[DEMO] Tesla Powertrain',
    owner: 'demo.rahul@pragati.local',
    description: 'Qualify the 4680 dry-electrode cell production line ahead of volume ramp.',
    daysFromNow: 60,
    priority: 'critical',
  },
  {
    name: '[DEMO] FSD v13 Regression Triage',
    code: 'DEMO-INC-2026-008',
    lifecycle: 'incident_management',
    team: '[DEMO] Autopilot & AI',
    owner: 'demo.ananya@pragati.local',
    description: 'Triage and root-cause perception regressions in the FSD v13 release candidate.',
    daysFromNow: 14,
    priority: 'critical',
  },
  {
    name: '[DEMO] Starbase Launch Procedure Refresh',
    code: 'DEMO-SOP-2026-014',
    lifecycle: 'training_program',
    team: '[DEMO] Starbase Engineering',
    owner: 'demo.lead@pragati.local',
    description: 'Update and re-certify the integrated launch procedures for the next flight campaign.',
    daysFromNow: 80,
    priority: 'medium',
  },
  {
    name: '[DEMO] Starlink Constellation Health Audit',
    code: 'DEMO-AUD-2026-005',
    lifecycle: 'audit',
    team: '[DEMO] Starlink',
    owner: 'demo.dhruv@pragati.local',
    description: 'Quarterly audit of on-orbit satellite health and deorbit compliance.',
    daysFromNow: 20,
    priority: 'high',
  },
  {
    name: '[DEMO] Autopilot Sprint 27',
    code: 'DEMO-AGI-2026-014',
    lifecycle: 'agile_sprint',
    team: '[DEMO] Autopilot & AI',
    owner: 'demo.lead@pragati.local',
    description: 'Two-week sprint on the occupancy-network perception stack.',
    daysFromNow: 10,
    priority: 'high',
  },
  {
    name: '[DEMO] Gigafactory Line Stoppage — Corrective Action',
    code: 'DEMO-CAPA-2026-003',
    lifecycle: 'capa',
    team: '[DEMO] Gigafactory Operations',
    owner: 'demo.lead@pragati.local',
    description: 'Root cause and corrective action for the Model Y general-assembly line stoppage.',
    daysFromNow: 45,
    priority: 'high',
  },
  {
    name: '[DEMO] Megapack Firmware Validation',
    code: 'DEMO-VAL-2026-018',
    lifecycle: 'validation',
    team: '[DEMO] Tesla Powertrain',
    owner: 'demo.rahul@pragati.local',
    description: 'Validate the new Megapack inverter firmware before the fleet rollout.',
    daysFromNow: 55,
    priority: 'medium',
  },
  {
    name: '[DEMO] Starship Flight Software v2.1 Release',
    code: 'DEMO-REL-2026-002',
    lifecycle: 'software_release',
    team: '[DEMO] Starbase Engineering',
    owner: 'demo.lead@pragati.local',
    description: 'Coordinated release of the Starship flight software v2.1.',
    daysFromNow: -3,
    priority: 'medium',
  },
  {
    name: '[DEMO] New Engineer Onboarding',
    code: 'DEMO-PRJ-2026-031',
    lifecycle: 'generic',
    team: '[DEMO] Starbase Engineering',
    owner: 'demo.ananya@pragati.local',
    description: 'Onboarding curriculum for new propulsion and avionics engineers.',
    daysFromNow: 70,
    priority: 'low',
  },
  {
    name: '[DEMO] Battery Telemetry Logging Upgrade',
    code: 'DEMO-CC-2026-0012',
    lifecycle: 'change_control',
    team: '[DEMO] Tesla Powertrain',
    owner: 'demo.rahul@pragati.local',
    description: 'Change control to extend high-rate battery telemetry logging across the fleet.',
    daysFromNow: 40,
    priority: 'medium',
  },
  {
    name: '[DEMO] Ground Station Software QA',
    code: 'DEMO-AUD-2026-006',
    lifecycle: 'audit',
    team: '[DEMO] Starlink',
    owner: 'demo.dhruv@pragati.local',
    description: 'Quality review of the ground-station gateway software across the last quarter.',
    daysFromNow: 12,
    priority: 'high',
  },
];
...
const TEAMS: TeamSpec[] = [
  {
    name: '[DEMO] Starbase Engineering',
    description: 'Starship program — design, build, and fly the fully reusable rocket.',
    function: 'general',
    lead: 'demo.lead@pragati.local',
    members: [
      'demo.lead@pragati.local',
      'demo.ic@pragati.local',
      'demo.rohit@pragati.local',
      'demo.isha@pragati.local',
      'demo.tara@pragati.local',
    ],
  },
  {
    name: '[DEMO] Tesla Powertrain',
    description: 'Battery, drive unit, and Megapack engineering.',
    function: 'general',
    lead: 'demo.rahul@pragati.local',
    members: [
      'demo.rahul@pragati.local',
      'demo.vikram@pragati.local',
      'demo.meera@pragati.local',
      'demo.aditya@pragati.local',
    ],
  },
  {
    name: '[DEMO] Autopilot & AI',
    description: 'Full Self-Driving and vehicle autonomy.',
    function: 'general',
    lead: 'demo.ananya@pragati.local',
    members: [
      'demo.ananya@pragati.local',
      'demo.ic@pragati.local',
      'demo.neha@pragati.local',
      'demo.tara@pragati.local',
    ],
  },
  {
    name: '[DEMO] Starlink',
    description: 'Satellite constellation and ground network.',
    function: 'general',
    lead: 'demo.dhruv@pragati.local',
    members: ['demo.dhruv@pragati.local', 'demo.arjun@pragati.local', 'demo.kavya@pragati.local'],
  },
  {
    name: '[DEMO] Gigafactory Operations',
    description: 'Manufacturing operations and production systems.',
    function: 'general',
    lead: 'demo.lead@pragati.local',
    members: ['demo.lead@pragati.local', 'demo.manish@pragati.local', 'demo.pooja@pragati.local'],
  },
  {
    name: '[DEMO] Raptor Propulsion',
    description: 'Raptor engine design, test, and production.',
    function: 'general',
    lead: 'demo.rahul@pragati.local',
    members: [
      'demo.rahul@pragati.local',
...
async function cleanDemo() {
  ...
  const [tasksDel, projDel, teamsDel, usersDel, auditDel, notifDel] = await Promise.all([
    Task.deleteMany({ $or: [{ projectId: { $in: demoProjectIds } }, { assigneeId: { $in: demoUserIds } }] }),
  ...
  console.log(
    `[seed:demo] removed: ${usersDel.deletedCount} users, ${teamsDel.deletedCount} teams, ${projDel.deletedCount} projects, ${tasksDel.deletedCount} tasks, ${auditDel.deletedCount} audit rows, ${notifDel.deletedCount} notifications`,
  );
}
...
async function buildDemo() {
  ...
  for (const spec of PROJECTS) {
    ...
    for (let phIdx = 0; phIdx < phases.length; phIdx++) {
      ...
      const titles: string[] = ((phaseTpl?.tasks || []) as any[]).map((t: any) =>
      ...
      for (let i = 0; i < titles.length; i++) {
        ...
        if (phaseRatio < 0.3) status = Math.random() < 0.85 ? 'done' : 'in_progress';
          ...
          status = ['done', 'in_progress', 'in_progress', 'todo', 'review'][Math.floor(Math.random() * 5)];
        ...
        const completedAt =
          status === 'done' ? new Date(tcd.getTime() - Math.floor(Math.random() * 5) * 86400000) : null;
        tasks.push({
          projectId: proj._id,
  ...
  const personalOwners = [
    usersByEmail.get('demo.ic@pragati.local')!,
    usersByEmail.get('demo.lead@pragati.local')!,
  ];
  const personalLifecycles: LifecycleKey[] = [
    'personal_career',
    'personal_study',
    'personal_fitness',
    'personal_reading',
  ...
  await AuditLog.insertMany([
    {
      ...
      actorName: lead.name,
      targetType: 'user',
      targetId: usersByEmail.get('demo.neha@pragati.local')!._id.toString(),
      targetLabel: 'Neha Patel (Demo)',
      summary: 'Updated username, employeeId',
      meta: {
        changes: {
          username: { before: 'np', after: 'demo.neha' },
          employeeId: { before: '', after: 'DEMO-2002' },
        },
        reason: 'Backfilled identity per AD sync',
      },
      createdAt: days(-14),
    },
    {
      ...
      actorName: lead.name,
      targetType: 'project',
      targetLabel: '[DEMO] eQMS Sprint 14',
  ...
  console.log('      …and 14 supporting engineers (demo.<first>@pragati.local).');
  console.log('');
