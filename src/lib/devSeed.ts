...
async function _devSeed() {
  ...
  const people = [
    ...
    {
      email: 'subhangini@qi.local',
      name: 'Subhangini Shetty',
      role: 'contributor',
      title: 'QA Specialist',
      pw: 'subhangini123',
    },
  ...
  await Task.insertMany([
    {
      projectId: p1._id,
      phaseId: p1Phases[0]._id,
      title: 'Requirement Finalization',
      assigneeId: U['subhangini@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 22),
      dueDate: fixed(2026, 4, 22),
      priority: 'high',
      taskType: 'task',
      gxpCritical: true,
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[1]._id,
      title: 'Design & Development',
      assigneeId: U['ronak@qi.local']._id,
      status: 'in_progress',
      dueDate: fixed(2026, 5, 15),
      priority: 'high',
      taskType: 'task',
      gxpCritical: true,
    ...
    },
    {
      projectId: p1._id,
      phaseId: p1Phases[1]._id,
      title: 'UI Design – Login & Grouping',
      assigneeId: U['bhoomika@qi.local']._id,
      status: 'in_progress',
      dueDate: fixed(2026, 5, 10),
      priority: 'high',
      taskType: 'task',
      gxpCritical: false,
      requiresQaSignoff: false,
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[2]._id,
      title: 'Testing (QA + UAT)',
      assigneeId: U['rishi@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 5, 20),
      priority: 'high',
      taskType: 'test',
      gxpCritical: true,
      requiresQaSignoff: true,
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[3]._id,
      title: 'Change Control Submission',
      assigneeId: U['subhangini@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 5, 22),
      priority: 'high',
      taskType: 'approval',
      gxpCritical: true,
      requiresQaSignoff: true,
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[4]._id,
      title: 'Configuration Deployment (Val)',
      assigneeId: U['ronak@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 5, 22),
      priority: 'high',
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[5]._id,
      title: 'Qualification (IQ/OQ/PQ)',
      assigneeId: U['dhruva@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 5, 31),
      priority: 'high',
      taskType: 'test',
      gxpCritical: true,
      requiresQaSignoff: true,
    },
    {
      ...
      phaseId: p1Phases[5]._id,
      title: 'SOP Revision',
      assigneeId: U['jimil@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 6, 25),
      priority: 'medium',
      taskType: 'task',
      gxpCritical: false,
      requiresQaSignoff: false,
    ...
    {
      projectId: p1._id,
      phaseId: p1Phases[6]._id,
      title: 'Configuration Deployment (PRD)',
      assigneeId: U['rishi@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 6, 28),
      priority: 'high',
      taskType: 'task',
      gxpCritical: true,
      requiresQaSignoff: false,
  ...
  await Task.insertMany([
    {
      projectId: p2._id,
      phaseId: p2Phases[0]._id,
      title: 'List of pending eLogbooks',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 16),
      dueDate: fixed(2026, 4, 16),
      priority: 'critical',
      taskType: 'task',
      gxpCritical: true,
    },
    {
      projectId: p2._id,
      phaseId: p2Phases[1]._id,
      title: 'Design Updation',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 14),
      dueDate: fixed(2026, 4, 30),
      priority: 'critical',
      taskType: 'task',
      gxpCritical: true,
    },
    {
      projectId: p2._id,
      phaseId: p2Phases[2]._id,
      title: 'Testing & UAT',
      assigneeId: U['rishi@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 10),
      dueDate: fixed(2026, 4, 10),
      priority: 'critical',
      taskType: 'test',
      gxpCritical: true,
      requiresQaSignoff: true,
    ...
    {
      projectId: p2._id,
      phaseId: p2Phases[3]._id,
      title: 'Change Control',
      assigneeId: U['subhangini@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 18),
      dueDate: fixed(2026, 4, 18),
      priority: 'critical',
      taskType: 'approval',
      requiresQaSignoff: true,
      gxpCritical: true,
    ...
    {
      projectId: p2._id,
      phaseId: p2Phases[6]._id,
      title: 'Configuration Deployment (PRD)',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 5, 2),
      priority: 'critical',
      taskType: 'task',
      gxpCritical: true,
    },
  ...
  await Task.insertMany([
    {
      projectId: p3._id,
      phaseId: p3Phases[0]._id,
      title: 'List & scope all impacted eLogbooks',
      assigneeId: U['subhangini@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 9),
      dueDate: fixed(2026, 4, 9),
      priority: 'critical',
      taskType: 'deviation',
      gxpCritical: true,
      requiresQaSignoff: true,
    ...
    {
      projectId: p3._id,
      phaseId: p3Phases[4]._id,
      title: 'Val Deployment',
      assigneeId: U['ronak@qi.local']._id,
      status: 'todo',
      dueDate: d(20),
      priority: 'critical',
    ...
    {
      projectId: p3._id,
      phaseId: p3Phases[6]._id,
      title: 'PRD Deployment',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'todo',
      dueDate: d(30),
      priority: 'critical',
  ...
  await Task.insertMany([
    {
      projectId: p4._id,
      phaseId: p4Phases[1]._id,
      title: 'Design Correction & UAT Confirmation',
      assigneeId: U['bhoomika@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 15),
      dueDate: fixed(2026, 4, 15),
      priority: 'high',
      taskType: 'task',
      gxpCritical: false,
    },
    {
      projectId: p4._id,
      phaseId: p4Phases[3]._id,
      title: 'Change Control Approval (OQ/PQ & SOP)',
      assigneeId: U['subhangini@qi.local']._id,
      status: 'done',
      completedAt: fixed(2026, 4, 18),
      dueDate: fixed(2026, 4, 18),
    ...
    {
      projectId: p4._id,
      phaseId: p4Phases[4]._id,
      title: 'Validation Deployment (Val)',
      assigneeId: U['yash@qi.local']._id,
      status: 'todo',
      dueDate: fixed(2026, 4, 20),
      priority: 'high',
      taskType: 'task',
      gxpCritical: true,
    },
  ...
  await Task.insertMany([
    {
      projectId: p5._id,
      phaseId: p5Phases[1]._id,
      title: 'LB Requirement Gathering (BE formats)',
      assigneeId: U['bhoomika@qi.local']._id,
      status: 'in_progress',
      dueDate: d(10),
      priority: 'medium',
    ...
    },
    {
      projectId: p5._id,
      phaseId: p5Phases[1]._id,
      title: 'UI Design – Quality LB (Redesign)',
      assigneeId: U['yash@qi.local']._id,
      status: 'todo',
      dueDate: d(18),
      priority: 'medium',
    ...
    {
      projectId: p5._id,
      phaseId: p5Phases[4]._id,
      title: 'Val Deployment / Package',
      assigneeId: U['rishi@qi.local']._id,
      status: 'todo',
      dueDate: d(35),
      priority: 'medium',
    ...
    {
      projectId: p5._id,
      phaseId: p5Phases[6]._id,
      title: 'PRD Deployment & Package',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'todo',
      dueDate: d(45),
      priority: 'medium',
  ...
  await Task.insertMany([
    {
      projectId: p6._id,
      phaseId: p6Phases[0]._id,
      title: 'VDC Enhancement -40 Analysis',
      assigneeId: U['ronak@qi.local']._id,
      status: 'done',
      completedAt: d(-10),
      dueDate: d(-8),
    ...
    {
      projectId: p6._id,
      phaseId: p6Phases[1]._id,
      title: 'Quality LB Design / Redesign',
      assigneeId: U['yash@qi.local']._id,
      status: 'in_progress',
      dueDate: d(7),
      priority: 'medium',
    ...
    {
      projectId: p6._id,
      phaseId: p6Phases[2]._id,
      title: 'Operation Support (Secondary)',
      assigneeId: U['bhoomika@qi.local']._id,
      status: 'todo',
      dueDate: d(14),
      priority: 'low',
    ...
    },
    {
      projectId: p6._id,
      phaseId: p6Phases[2]._id,
      title: 'Master Data Enhancement WF (Qual LB)',
      assigneeId: U['jimil@qi.local']._id,
      status: 'todo',
      dueDate: d(21),
      priority: 'medium',
    ...
    {
      projectId: p6._id,
      phaseId: p6Phases[3]._id,
      title: 'DEV Server Cloud Migration',
      assigneeId: U['nikesh@qi.local']._id,
      status: 'todo',
      dueDate: d(30),
      priority: 'high',
    ...
    {
      projectId: p6._id,
      phaseId: p6Phases[4]._id,
      title: 'Fix Verification / Operation Support',
      assigneeId: U['rishi@qi.local']._id,
      status: 'todo',
      dueDate: d(35),
      priority: 'medium',
  ...
  if (designTask) {
    (designTask as any).subtasks.push(
      {
        title: 'Figma wireframes – login flow',
        assigneeId: U['bhoomika@qi.local']._id,
        status: 'done',
        dueDate: d(2),
        completedAt: d(-2),
      ...
      {
        title: 'Backend API for unified auth',
        assigneeId: U['ronak@qi.local']._id,
        status: 'in_progress',
        dueDate: d(5),
        position: 1,
  ...
  const historyFor = async (email: string, months: number[]) => {
    ...
    for (const m of months) {
      ...
      completed.setMonth(completed.getMonth() - m);
      const due = new Date(completed);
      due.setDate(due.getDate() + Math.ceil(1 + Math.random() * 4));
      await Task.create({
        projectId: p1._id,
