...
export const KB: KBEntry[] = [
  // ── Shared login / credentials ───────────────────────────────────────────
  {
    ...
    summary:
      'Yes — this is a data integrity finding. Using a shared login to approve a GxP document violates ALCOA+ (Attributable principle): the record cannot be attributed to a specific individual. This is a regulatory red flag.',
  ...
  // ── Audit trail disabled ─────────────────────────────────────────────────
  {
    ...
    summary:
      'A disabled audit trail in a GxP system is a critical data integrity violation. All activity during the gap period is potentially unattributable, creating significant regulatory exposure.',
  ...
  // ── What is a deviation ──────────────────────────────────────────────────
  {
    ...
    keywords: [
      'what is a deviation',
      'what is deviation',
      'do i need a deviation',
      'when do i need a deviation',
      'is this a deviation',
      'need to raise deviation',
      'should i log deviation',
      'what counts as deviation',
    ],
    title: 'What Is a Deviation and When Do You Need One?',
    summary:
      'A deviation is any departure from an approved procedure, specification, or standard — whether planned or unplanned. If something happened differently from how your SOP says it should happen, you likely need a deviation.',
  ...
  // ── CAPA ─────────────────────────────────────────────────────────────────
  {
    ...
    summary:
      'A CAPA addresses the root cause of a quality problem (corrective) and prevents it from happening again elsewhere (preventive). It\'s more than just "we fixed it" — you need to prove you found the real cause and eliminated it.',
  ...
  // ── Change control ───────────────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      'system change',
      'process change',
      'when do i need change control',
      'do i need change control',
      'raise a change',
      'change approval',
    ...
    summary:
      "Any planned change to a validated system, approved procedure, or critical equipment that could affect product quality or patient safety needs a change control. The key word is planned — if it was unplanned and already happened, that's a deviation.",
  ...
  // ── GAMP 5 / Software categories ─────────────────────────────────────────
  {
    ...
    summary:
      'GAMP 5 categorizes software by the level of validation effort required. The higher the category, the more custom the software and the more validation work needed.',
  ...
  // ── CSV / IQ OQ PQ ───────────────────────────────────────────────────────
  {
    ...
    summary:
      "CSV is the documented evidence that a computerized system consistently does what it's supposed to do. IQ/OQ/PQ are the three phases of testing that prove this.",
  ...
  // ── Out of specification / OOS ────────────────────────────────────────────
  {
    ...
    summary:
      'An OOS result means a test result falls outside the approved specification limits. You cannot dismiss it without a full investigation — releasing product based on an uninvestigated OOS is a serious regulatory violation.',
  ...
  // ── Document control ─────────────────────────────────────────────────────
  {
    ...
    summary:
      "Every GxP document (SOP, batch record, protocol) must follow a defined lifecycle: draft → review → approval → effective. You cannot use a document before it's approved, and you must train people before its effective date.",
  ...
  // ── 483 / inspection finding ─────────────────────────────────────────────
  {
    ...
    keywords: [
      ...
      'how to respond to 483',
      'prepare for inspection',
    ],
    title: 'Responding to an Inspection Finding (483 Observation)',
    summary:
      "A 483 is a list of observations from an FDA inspector — it's not a final determination, but your response within 15 business days is critical. A strong, substantive response can prevent escalation to a Warning Letter.",
  ...
  // ── Data integrity / ALCOA ───────────────────────────────────────────────
  {
    ...
    summary:
      'ALCOA+ defines the standards for GxP data quality. Every record you create must be Attributable, Legible, Contemporaneous, Original, and Accurate — plus Complete, Consistent, Enduring, and Available.',
    ...
    regulatory:
      'MHRA Data Integrity Guidance; FDA Data Integrity Draft Guidance; EU Annex 11; ALCOA+ WHO Guidelines',
    steps: [
  ...
  // ── Production change without approval ───────────────────────────────────
  {
    ...
    keywords: [
      ...
      'implemented change without',
      'production change without',
    ],
    title: 'Made a Change Without Going Through Change Control',
    summary:
      'An unapproved change to a validated system is a deviation — it needs to be documented immediately, even if the change turned out to be fine. "It worked" doesn\'t eliminate the compliance obligation.',
  ...
  // ── Test in production ───────────────────────────────────────────────────
  {
    ...
    summary:
      'Running test scripts or unapproved code on a production GxP system is a serious incident. The validated state of the system may have been compromised, and any data generated is suspect.',
  ...
  // ── GMP basics ───────────────────────────────────────────────────────────
  {
    ...
    summary:
      'GMP (Good Manufacturing Practice) is the set of rules that ensure medicines are consistently produced and controlled to quality standards. Every signature, second check, and record exists to prove the product was made correctly.',
  ...
  // ── Batch release with issue ──────────────────────────────────────────────
  {
    ...
    summary:
      'If a batch has already been released and a quality issue is discovered, the response escalates significantly. You may be looking at a market withdrawal or recall depending on the risk.',
  ...
  // ── Password / access change to GxP system ───────────────────────────────
  {
    ...
    summary:
      'Access changes to GxP systems are controlled activities. Adding, removing, or changing user roles must be documented and, in validated systems, may require a change control.',
