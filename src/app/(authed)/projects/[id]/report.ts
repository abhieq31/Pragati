...
<body>
  <div class="page">
    <div class="brand">
      <span class="mark">
        <svg width="34" height="34" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <defs><linearGradient id="pg" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse"><stop stop-color="#0f4c99"/><stop offset="0.4" stop-color="#1565C0"/><stop offset="1" stop-color="#1b7f3a"/></linearGradient></defs>
          <rect width="64" height="64" rx="18" fill="url(#pg)"/>
          <path d="M30 30 C26 25 15 21 8 27 C4 31 8 38 18 35 C24 33 28 31 30 30" fill="white" opacity="0.92"/>
          <path d="M34 30 C38 25 49 21 56 27 C60 31 56 38 46 35 C40 33 36 31 34 30" fill="white" opacity="0.92"/>
          <ellipse cx="32" cy="29" rx="3.5" ry="7" fill="white" opacity="0.97"/>
          <path d="M28.5 36 L32 44 L35.5 36" fill="white" opacity="0.72"/>
        </svg>
        <span class="logo">MicroMacro<small>Bird's eye view</small></span>
      </span>
    ...
    <div class="footer">Generated by MicroMacro · ${esc(ref)} · ${esc(generated)}${exportedBy ? ` · Exported by ${esc(exportedBy)}` : ''}</div>
  </div>
</body></html>`;
}
